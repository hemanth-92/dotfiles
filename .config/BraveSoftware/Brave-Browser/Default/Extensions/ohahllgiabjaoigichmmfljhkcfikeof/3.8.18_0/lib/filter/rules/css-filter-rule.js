...
(function (abu, api) {
    ...
    var CssFilterRule = (function () {
        ...
        var parsePseudoClass = function (selector) {
            ...
            var nameEndIndex = abu.utils.strings.indexOfAny(selector, nameStartIndex + 1, [' ', '\t', '>', '(', '[', '.', '#', ':', '+', '~', '"', "'"]);
            if (nameEndIndex < 0) {
    ...
    CssFilterRule.SUPPORTED_PSEUDO_CLASSES = [":active",
        ...
        ":-abp-has", ":-abp-contains", ":xpath", ":nth-ancestor",
        ":upward", ":remove", ":matches-attr", ":matches-property", ":is"];
