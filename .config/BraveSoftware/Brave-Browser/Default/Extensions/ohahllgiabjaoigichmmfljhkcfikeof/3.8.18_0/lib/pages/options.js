...
PageController.prototype = {
    ...
    _bindEvents: function () {
		...
		this.enableContextMenuCheckbox = $("#enableContextMenuCheckbox");
		...
		this.enableContextMenuCheckbox.on('change', this.enableContextMenuChange);
    ...
    _render: function () {
        ...
        var enableContextMenu = !userSettings.values[userSettings.names.DISABLE_SHOW_CONTEXT_MENU];
        ...
        this._renderEnableContextMenu(enableContextMenu);
    ...
    enableContextMenuChange: function () {
        contentPage.sendMessage({
            type: 'changeUserSetting',
    ...
    _renderEnableContextMenu: function (enableContextMenu) {
        this.enableContextMenuCheckbox.updateCheckbox(enableContextMenu);
    },
...
if ((typeof abu !== 'undefined') && abu.utils.browser.isFirefoxBrowser()) {
    function connect() {
