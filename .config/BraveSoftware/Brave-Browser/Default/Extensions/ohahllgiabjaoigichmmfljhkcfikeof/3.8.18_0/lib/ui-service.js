...
abu.ui = (function (abu) { 
    ...
    function addMenu(title, options) {
        ...
        createProperties.id = createProperties.id || title;

        if (typeof callback === 'function') {
            contextMenuEventHandlers[createProperties.id] = callback;
        }
    ...
    function handleContextMenuClick(info, tab) {
        const handler = contextMenuEventHandlers[info.menuItemId];
    ...
    function updateTabContextMenu(tab) {
        ...
        abu.contextMenus.onClicked.removeListener(handleContextMenuClick);
        if (abu.settings.showContextMenu()) {
            ...
            abu.contextMenus.onClicked.addListener(handleContextMenuClick);
        }
    }
