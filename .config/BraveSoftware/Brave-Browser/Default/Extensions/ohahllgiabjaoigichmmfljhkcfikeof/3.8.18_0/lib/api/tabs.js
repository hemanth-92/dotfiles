...
abu.windowsImpl = (function (abu) {
    ...
    var onUpdatedChannel = abu.utils.channels.newChannel();
    ...
    var forEachNative = function (callback) {
        ...
        // https://github.com/abuTeam/abuBrowserExtension/issues/569
    ...
    return {
        ...
        onCreated: onCreatedChannel, // callback (abuWin, nativeWin)
...
abu.tabsImpl = (function (abu) {
    ...
    function checkLastError(operation) {
        ...
        if (ex) {
            abu.console.error("Error while executing operation{1}: {0}", ex, operation ? " '" + operation + "'" : '');
        }
        return ex;
    }
    ...
    var onActivatedChannel = abu.utils.channels.newChannel();
    ...
    function focusWindow(tabId, windowId, callback) {
         ...
         * https://github.com/abuTeam/abuBrowserExtension/issues/675
         */
    ...
    var create = function (createData, callback) {
        ...
        if (createData.type === 'popup' &&
            ...
            !abu.utils.browser.isEdgeBeforeCreatorsUpdate() &&
        ...
        function onWindowFound(win) {
            ...
            browser.tabs.create({
                 ...
                 */
                windowId: !abu.prefs.mobile ? win.id : undefined,
                url: url,
                active: active,
            }, function (chromeTab) {
                if (active) {
    ...
    var reload = function (tabId, url) {
        if (url) {
            if (abu.utils.browser.isEdgeBrowser()) {
                /**
                 ...
                 * https://github.com/abuTeam/abuBrowserExtension/issues/580
                 */
                setTimeout(function () {
